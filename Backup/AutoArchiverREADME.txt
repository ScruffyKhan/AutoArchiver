...
-       For MonthlyArchive scripts the DAYS_TO_SUBTRACT variable is used to pick the month you wish to archive by subtracting DAYS_TO_SUBTRACT days from the 
	date the script is run, the script then archives whatever month that is. I.E. if you run the script on the 1st workday of every month and want to keep 
	one months worth the data unarchived, you could set the DAYS_TO_SUBTRACT variable to 45 that would subtract 45 days or a month and a half from the first
	workday of the month and would set the month to archive to 2 months previous.
...
Developer:		Elliot Carter (AMPS Web Team)
Contact:		ecarter1117@gmail.com
